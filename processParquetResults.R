...
profoundBothCis <- readAllCis(paste0(eQTLDir, "/profoundBothResults.cis_qtl_pairs"))
profoundModerateIDCis <- readAllCis(paste0(eQTLDir, "/profoundModerateIDOnlyResults.cis_qtl_pairs"))
profoundNonverbalCis <- readAllCis(paste0(eQTLDir, "/profoundNonverbalOnlyResults.cis_qtl_pairs"))
verbalGiftedCis <- readAllCis(paste0(eQTLDir, "/verbalGiftedResults.cis_qtl_pairs"))
verbalNoIDCis <- readAllCis(paste0(eQTLDir, "/verbalNoIDResults.cis_qtl_pairs"))
verbalMildCis <- readAllCis(paste0(eQTLDir, "/verbalMildIDResults.cis_qtl_pairs"))
...
profoundBothSig <- getAboveCutoff(arrow::read_parquet(paste0(eQTLDir, "/profoundBothResultsTrans.trans_qtl_pairs.parquet")))
profoundNonverbalOnlySig <- getAboveCutoff(arrow::read_parquet(paste0(eQTLDir, "/profoundNonverbalOnlyResultsTrans.trans_qtl_pairs.parquet")))
profoundModerateIDOnlySig <- getAboveCutoff(arrow::read_parquet(paste0(eQTLDir, "/profoundModerateIDOnlyResultsTrans.trans_qtl_pairs.parquet")))
#notProfoundTransSig <- getAboveCutoff(arrow::read_parquet(paste0(eQTLDir, "/notProfoundAllResultsTrans.trans_qtl_pairs.parquet")))
verbalGiftedTransSig <- getAboveCutoff(arrow::read_parquet(paste0(eQTLDir, "/verbalGiftedResultsTrans.trans_qtl_pairs.parquet")))
verbalNoIDTransSig <- getAboveCutoff(arrow::read_parquet(paste0(eQTLDir, "/verbalNoIDResultsTrans.trans_qtl_pairs.parquet")))
verbalMildIDTransSig <- getAboveCutoff(arrow::read_parquet(paste0(eQTLDir, "/verbalMildIDResultsTrans.trans_qtl_pairs.parquet")))
